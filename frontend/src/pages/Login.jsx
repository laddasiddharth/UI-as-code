...
export default function Login() {
  ...
  return (
    <div className="min-h-[100svh] flex items-center justify-center py-12 px-5 sm:px-8 relative overflow-hidden">
      ...
      <div className="max-w-lg w-full space-y-7 glass-panel p-6 sm:p-8 rounded-[28px] sm:rounded-[32px] relative z-10">
        <div className="text-center">
          <div className="mx-auto bg-[color:var(--accent)]/15 w-12 h-12 rounded-2xl flex items-center justify-center mb-5">
