  ...
  return (
    <div className="space-y-6 sm:space-y-8">
      <header className="mb-8 sm:mb-10">
        ...
        <h1 className="font-display text-3xl sm:text-5xl text-[color:var(--ink)] mt-3">Dashboard Atelier</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-5 sm:gap-6 mb-8 sm:mb-10">
        <div
          ...
          className="ink-card p-5 sm:p-6 rounded-3xl transition-all cursor-pointer group hover:-translate-y-1"
        >
        ...
        <div className="ink-card p-5 sm:p-6 rounded-3xl transition-all cursor-pointer group hover:-translate-y-1">
      ...
      <div className="ink-card rounded-3xl overflow-hidden">
        <div className="px-5 sm:px-6 py-5 border-b border-[color:var(--border)] bg-[color:var(--panel)]">
          <h2 className="font-display text-xl text-[color:var(--ink)]">Recent Projects</h2>
        </div>
        <div className="p-5 sm:p-6 text-center text-[color:var(--muted)] py-10 sm:py-12">
          No projects found.{' '}
          <button
            onClick={() => navigate('/generate')}
